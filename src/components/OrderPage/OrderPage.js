        ...
        <div className="order-details-wrapper">
          <div className="pet-details-container">
            ...
            <div className="pet-info">
              <p>
                Type: <span>{orderDetails?.type}</span>
              </p>
              <p>
                Breed: <span>{orderDetails?.breed}</span>
              </p>
              <p>
                ...
                {selectedPaymentOption === "Card" && (
                  <div className="card-payment-info">
                    <input
                      ...
                      onChange={(e) =>
                        onFieldChange("cardNumber", e.target.value)
                      }
                    />
                    <input
                      type="text"
                      ...
                      onChange={(e) =>
                        onFieldChange("cardExpiry", e.target.value)
                      }
                    />
                  </div>
                )}
                {selectedPaymentOption === "UPI" && (
                  <div className="upi-payment-info">
                    <input
                      type="text"
                      value={upiId}
                      placeholder="UPI ID: abc@okhdfcbank"
